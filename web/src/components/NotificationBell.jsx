...
export default function NotificationBell({ onNavigate }) {
  ...
  return (
    <div className="relative" ref={wrapRef}>
      ...
      {open && (
        <div className="absolute right-0 top-full mt-2 w-[19rem] sm:w-80 max-h-[70vh] flex flex-col bg-white dark:bg-neutral-950 border border-neutral-200 dark:border-neutral-850 rounded-2xl shadow-2xl z-50 overflow-hidden animate-fade-in">
