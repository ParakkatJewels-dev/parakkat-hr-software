...
export default function ListSearch({ value, onChange, label = 'Search records', placeholder = 'Search by name or code…' }) {
  return <label className="input-shell flex min-w-0 items-center gap-2 rounded-xl border border-neutral-200 dark:border-neutral-800 bg-white dark:bg-neutral-950 px-3 py-2.5 text-neutral-500">
