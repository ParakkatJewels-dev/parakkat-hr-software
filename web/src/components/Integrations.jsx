...
import { Share2, ToggleLeft, ToggleRight } from 'lucide-react';
            ...
            >
              <div>
                <div className="flex justify-between items-start">
                  ...
                  <span className="text-2xs uppercase font-mono px-1.5 py-0.2 bg-neutral-200 dark:bg-neutral-900 text-neutral-500 rounded">
                    {app.type}
                  </span>
                </div>
                <p className="text-xs text-neutral-500 dark:text-neutral-450 mt-1.5 leading-snug">{app.desc}</p>
              </div>
              ...
              <div className="flex justify-between items-center border-t border-neutral-150 dark:border-neutral-900/40 pt-2.5 mt-2">
                ...
                >
                  {app.connected ? (
                    ...
                    <ToggleLeft size={26} className="text-neutral-450 dark:text-neutral-700" />
                  )}
                </button>
              </div>
            </div>
